...
public class AlgoFPGrowth {
    ...
    public Itemsets runAlgorithm(FPTree tree, int logSize, HashMap<Integer, Integer> mapSupport, HashMap<Integer, List<Integer>> mapTraceList, List<Integer> mapTraces) throws IOException {
