...
public class Itemset extends AbstractOrderedItemset{
	...
	public List<Integer> traceList= new ArrayList<Integer>();
	 ...
	 */
	public Itemset(List<Integer> itemset, int support, List<Integer> tracelist){
	...
	public void setTraceList(List<Integer> traces) {
		this.traceList= traces; 
	}
	public void addTrace(int i) {
		this.traceList.add(i);
	}
