...
public class ActivitySelectionPlugin {
    ...
    public class MatrixFilterWizardPanel extends JPanel {
        ...
        private final SamplingType[] SamplingOptions = SamplingType.values();
        private final SamplingReturnType[] ReturnOptions = SamplingReturnType.values();
        private final FilterSelection[] KeepOrRemove = FilterSelection.values();
        ...
        private final NiceIntegerSlider SubsequenceLength = SlickerFactory.instance().createNiceIntegerSlider("Please Select the Percentages of Activities", 0, 100, 75, Orientation.HORIZONTAL);
