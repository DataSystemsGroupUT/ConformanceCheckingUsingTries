...
//						max = probs.get(prevVisibleDF);
    ...
    protected static class traceState {
        ...
        private static final HashSet<String> selfLoops = new HashSet<String>();
        private static final HashMap<String, Integer> loops = new HashMap<String, Integer>();
