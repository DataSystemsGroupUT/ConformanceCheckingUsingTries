...
public class MixedSimulator2 extends LogSimulator2 {
    ...
    private final ArrayList<String> sortedPatterns;
    private final Pattern scapeSpecial = Pattern.compile("[^A-Za-z0-9]");
    private final Pattern repeatingPattern = Pattern.compile("(.+?)\\1+");
    private final boolean compressed;
    private final ArrayList<HashSet<String>> PX; /// all the model prefixes
    private final ArrayList<HashSet<String>> tempPX;//  not extended
    private final HashSet<String> tempRemoved;  ///
...
//		}
    ...
    public boolean isTrieEmpty() {
        return trie.getNumberOfWords() == 0;
    }
